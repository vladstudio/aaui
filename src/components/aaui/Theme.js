export const Theme = {
  button: {
    ...
    default:
      "border-stone-500/30 bg-white hover:bg-orange-50 hover:border-orange-500/30 active:shadow-[inset_0_2px_0_0_#11111108,0_1px_0px_1px_#FFF8,0_-1px_0px_1px_#00000005]",
    primary: "bg-stone-800 hover:bg-orange-800 text-white",
    ghost: "border-transparent hover:bg-orange-500/20",
  },
